...
def process_bms_data(data):
    try:
        # Example parsing logic (update based on actual protocol)
        pack_data = data.get('pack_data', '')
        cell_voltages = [parse_hex_data(pack_data[i:i+4]) for i in range(0, len(pack_data), 4)]
